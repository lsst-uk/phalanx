  ...
  <CardGroup>
    <a href="https://dp1.lsst.io/">
      <Card>
        ...
        The DP1 release on the UK DAC is an early version and is not as comprehensive
        as the release on data.lsst.cloud. In particular, there is no TAP access 
        (you must use the Butler interface to interrogate the dataset) and the 
        <a href="https://dp1.lsst.io/products/known_issues_and_subtleties.html#wcs-fits-approximations-and-misleading-interfaces">WCS fix released           in January 2026</a>
        is not included.
      </Card>
    </a>
  </CardGroup>
